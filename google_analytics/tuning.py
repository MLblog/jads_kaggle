...
def eval_permutation(params, predictor_cls, train_x, train_y, method='split', nfolds=3, silent=True):
    """
    ...
    :param train_y: Array of target values
    ...
    score = predictor.evaluate(train_x, train_y, method=method, nfolds=nfolds)
...
def bayesian_optimization(predictor_cls, train_x, train_y, params, max_iter, max_time=600, model_type='GP', acquisition_type='EI',
